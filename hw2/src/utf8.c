...
{
  switch(size) {
  utf8_glyph_t (*uef)(code_point_t);
  case 1:
    uef = &utf8_one_byte_encode;
    return uef;
  case 2:
    uef = &utf8_two_byte_encode;
    return uef;
  case 3:
    uef = &utf8_three_byte_encode;
    return uef;
  case 4:
    uef = &utf8_four_byte_encode;
    return uef;
  }
  return NULL;
}
...
{
  switch(size) {
  code_point_t (*bar)(utf8_glyph_t);
  case 1:
    bar = &utf8_one_byte_decode;
    return bar;
  case 2:
    bar = &utf8_two_byte_decode;
    return bar;
  case 3:
    bar = &utf8_three_byte_decode;
    return bar;
  case 4:
    bar = &utf8_four_byte_decode;
    return bar;
  }
  return NULL;
}
